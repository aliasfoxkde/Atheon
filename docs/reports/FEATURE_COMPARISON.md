...
|---------|----------------|-------------------|
| **Pattern Count** | 57 | 327+ |
| **Pattern Categories** | 8 | 23+ |
...
### **1. Expanded Pattern Library (327+ patterns vs 57)**
...
#### **AI Detection Patterns (21+ patterns)**
Core AI detection:
- ✅ AI buzzwords (synergize, leverage, cutting-edge, paradigm shift)
- ✅ AI-generated code disclaimers (generated by AI, written by ChatGPT)
- ✅ AI emoji overuse (✨, 🚀, 💡, ⚡, 🎯, 🔥)
- ✅ Hallucination placeholders ([INSERT CODE], [YOUR IMPLEMENTATION])
- ✅ Incomplete AI-generated code (add your implementation)
- ✅ AI template artifacts (your code, placeholder code)
- ✅ Overuse patterns (multiple, various, numerous)
- ✅ LLM generated markers (as an AI language model)

Anti-cheating / evaluation harness integrity:
- ✅ Benchmark gaming detection (overfitting to specific tests)
- ✅ Harness feedback loop detection (SUT writing own evaluation results)
- ✅ Test data memorization (hardcoded answer tables)
- ✅ System prompt leakage (verbatim instruction repetition)
- ✅ Differential output (context-conditional behavior)
- ✅ Seed exploitation (predictable random seed abuse)
- ✅ Harness environment detection (is_ci, EVAL_MODE detection)
- ✅ Output sanitization bypass attempts
- ✅ Weak ground truth (ambiguous evaluation criteria)
- ✅ Harness shared state (non-reproducible test infrastructure)
- ✅ Leaderboard SQL injection vulnerabilities
- ✅ Sandbox timeout bypass attempts
...
### **For Security Teams**
**Enhanced Version Recommended**:
- 327+ patterns across 23 categories
...
*This comparison is maintained and updated with each release. Last updated: 2026-06-27*