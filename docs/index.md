...
Pattern-matching engine for secrets, PII, and code quality. 255+ patterns, SARIF output, MCP server for AI assistant integration.
...
```bash
go install github.com/aliasfoxkde/Atheon/cmd/atheon@latest
