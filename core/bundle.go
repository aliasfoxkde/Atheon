...
// downloadURL is overridable for testing
var downloadURL = "https://github.com/HoraDomu/Atheon/releases/latest/download/patterns.bundle"

// SetBundleDownloadURL overrides the bundle download URL for testing.
// Returns a restore function to reset to the default.
func SetBundleDownloadURL(url string) func() {
	old := downloadURL
	downloadURL = url
	return func() { downloadURL = old }
}
